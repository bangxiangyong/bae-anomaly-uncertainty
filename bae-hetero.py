...
n_samples= 1500
X1 = np.random.normal(loc=0.2,scale=0.005,size=n_samples)
...
#specify decoder-mu
decoder_mu = infer_decoder(encoder,activation="relu",last_activation="sigmoid") #symmetrical to encoder
...
# train mu network
train_loader = convert_dataloader(X)
run_auto_lr_range_v2(train_loader, bae_ensemble)
