...
x_outliers_test, _ = train_test_split(x_outliers_test, train_size=0.01,shuffle=True, random_state=100)
X = x_inliers_train
...
encoder = Encoder([DenseLayers(input_size=input_dim,
                               architecture=[8,8],
                               output_size=8, activation=activation,last_activation=activation
                               )])
...
#                                     x_outliers=scaler.transform(x_outliers_test),
#                                     num_epochs=10)
#
