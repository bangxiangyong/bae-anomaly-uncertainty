...
chain_params = [
    ...
    #     "base": "conv2d",
    #     "input_dim": input_dim,
    #     "conv_channels": [input_channel, 5, 10, 12],
    #     "conv_stride": [2, 1, 2],
    #     "conv_kernel": [4, 4, 4],
    #     "activation": "silu",
    #     "norm": True,
...
# bae_model.init_scheduler(half_iterations=half_iter, min_lr=min_lr, max_lr=0.05)


# bae_model.init_scheduler(
#     half_iterations=len(train_loader) // 2, min_lr=1.99e-05, max_lr=0.01
# )
