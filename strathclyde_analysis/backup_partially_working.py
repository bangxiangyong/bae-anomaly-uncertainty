...
cmm_data = pickle.load(open(pickle_path + "/" + "strath_outputs_err.p", "rb")).values
# cmm_data = np.abs(cmm_data) ** 2
...
# ood and id
tukey_flags = np.apply_along_axis(flag_tukey_fence, arr=cmm_data, axis=0, level=1.5)
...
chain_params = [
    ...
    #     "base": "conv1d",
    #     "input_dim": input_dim,
    #     "conv_channels": [x_id_train.shape[1], 10, 32],
    #     "conv_stride": [2, 2],
    #     # "conv_kernel": [200, 10],
    #     "conv_kernel": [100, 10],
